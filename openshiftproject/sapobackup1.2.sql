...
--
-- Name: notificaciones_parametros; Type: TABLE; Schema: public; Owner: adminf6gzvny; Tablespace: 
--
...
ALTER TABLE notificaciones_parametros OWNER TO adminf6gzvny;

--
-- Name: notificaciones_parametros_id_seq; Type: SEQUENCE; Schema: public; Owner: adminf6gzvny
--
...
ALTER TABLE notificaciones_parametros_id_seq OWNER TO adminf6gzvny;

--
-- Name: notificaciones_parametros_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: adminf6gzvny
--
...
--
-- Name: tipo_cuenta; Type: TABLE; Schema: public; Owner: adminf6gzvny; Tablespace: 
--
...
ALTER TABLE tipo_cuenta OWNER TO adminf6gzvny;

--
-- Name: tipo_cuenta_id_seq; Type: SEQUENCE; Schema: public; Owner: adminf6gzvny
--
...
ALTER TABLE tipo_cuenta_id_seq OWNER TO adminf6gzvny;

--
-- Name: tipo_cuenta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: adminf6gzvny
--
...
--
-- Name: id; Type: DEFAULT; Schema: public; Owner: adminf6gzvny
--
...
COPY avs (id, id_usuario_duenio, nombre, descripcion, privada) FROM stdin;
2	leo	almacendeleo	el super almacen de leo	f
4	alebarreiro@live.com	Almacen 1	Mi primera almacen desde la app angular	f
5	alebarreiro@live.com	Almacen 2	Descripcion almacen 2	f
6	alebarreiro@live.com	Almacen 3	Descripcion almacen 3	f
7	alebarreiro@live.com	Almacen 4	descripcion almacen 4	f
8	alebarreiro@live.com	almacen5	la desc 5	f
9	alebarreiro@live.com	almacen6	Y YA ME TIENE RE PODRIDO	f
10	alebarreiro@live.com	Almacen7	Ahora si?	f
11	leo	openshift redeploy	set descrition asd	f
12	alebarreiro@live.com	Almacen 8	Descripcion almacen 8	f
13	alebarreiro@live.com	almacen9	Esta va con categorias!	f
14	alebarreiro@live.com	almacen10	ahora si, con categorías! (esperemos)	f
15	alebarreiro@live.com	Almacen 11	Bueno, la tercera es la vencida. Ahora si va con categorias.	f
16	gmunua	www.nacional.com.uy	Plantel principal del Club Nacional de Football	f
17	alebarreiro@live.com	Prueba2	Esto es una prueba	f
18	alebarreiro@live.com	Prueba 3	prueba antes de la demo	f
19	alebarreiro@live.com	otra tienda	Descripcion de la tienda	f
20	alebarreiro@live.com	Demo prototipo	Una descripcion de la almacen	f
22	alejandroanonmallo@gmail.com	FC Barcelona	Barca	f
CAP Manda!	alebarreiro@live.com	Nombre	5-0	f
LaAlmacenDeAlejo	alebarreiro@live.com	Alejo	La descripción de Alejo	f
mitienda1	alebarreiro@live.com	mitienda1	descripcion	f
aletest2	alebarreiro@live.com	mitest2	test2	f
aletest3	alebarreiro@live.com	aletest3	test3	f
aletest4	alebarreiro@live.com	aletest4	DEsctest3	f
testale5	alebarreiro@live.com	testale5	Ahora con productos?	f
aletest6	alebarreiro@live.com	aletest6	pruebita con prods 2?	f
testale7	alebarreiro@live.com	testale7	testale7 productos	f
aletest7	alebarreiro@live.com	aletest7	desc 7	f
testale8	alebarreiro@live.com	testale8	testale8 prods	f
testale9	alebarreiro@live.com	testale9	testazo	f
testale10	alebarreiro@live.com	testale10	testazo 10	f
testale11	alebarreiro@live.com	testale11	testale1111111	f
testale12	alebarreiro@live.com	testale12	testale12	f
testale13	alebarreiro@live.com	testale13	descripcion almacen	f
testale14	alebarreiro@live.com	testale14	descripcion almacen ale 14	f
testale15	alebarreiro@live.com	testale15	descripc	f
aaaaaaaaa2	leo	mytienda	set descrition here	f
\.
...
--
-- Data for Name: notificaciones_parametros; Type: TABLE DATA; Schema: public; Owner: adminf6gzvny
--
...
--
-- Name: notificaciones_parametros_id_seq; Type: SEQUENCE SET; Schema: public; Owner: adminf6gzvny
--
...
28	prueba1510	o	1	f
31	hola	e	1	t
32	productoejemplo	descripcion	1	f
33	Caballo	Es un equino.	6	f
34	Perro	Es un can.	6	f
\.
...
SELECT pg_catalog.setval('productos_id_seq', 34, true);
...
--
-- Data for Name: tipo_cuenta; Type: TABLE DATA; Schema: public; Owner: adminf6gzvny
--

COPY tipo_cuenta (id, nombre, descripcion, precio) FROM stdin;
1	FREE	Cuenta Free	0
2	GOLD	Cuenta Gold	10000
\.


--
-- Name: tipo_cuenta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: adminf6gzvny
--
...
COPY usuarios (id, nombre, apellido, token, tipo_cuenta) FROM stdin;
leonardo	leonardin	clavijoupdated	\N	1
leo	leo	apellido	\N	1
god	tonton	tintin	\N	1
god2	asa	asaaa	\N	1
PEPITO	LOCO	PAJARITO	\N	1
gmunua	Gustavo	Munúa	\N	1
maildefb@domain.com	um certo	alguem	9283982sdbsdjhtokenfb	1
maildefbdelchino@domain.com	Vamoooo	alguem	9283982sdbsdjhtokenfb	1
alejandroanonmallo@gmail.com	Añón	Alejandro	10207577810028295	1
alebarreiro@live.com	Alejandro	Barreiro	\N	2
\.
...
god	2
alejandroanonmallo@gmail.com	testale5
alejandroanonmallo@gmail.com	testale8
alejandroanonmallo@gmail.com	testale15
\.
...
--
-- Name: notificaciones_parametros_pkey; Type: CONSTRAINT; Schema: public; Owner: adminf6gzvny; Tablespace: 
--
...
--
-- Name: tipo_cuenta_pkey; Type: CONSTRAINT; Schema: public; Owner: adminf6gzvny; Tablespace: 
--
...
--
-- Name: notificaciones_parametros_avid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: adminf6gzvny
--
...
--
-- Name: notificaciones_parametros_productoid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: adminf6gzvny
--
